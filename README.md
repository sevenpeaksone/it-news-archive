...
IT/AI/technology 주제의 **상세 기사형 콘텐츠** 공개 archive입니다.
...
- `assets/charts/`: 필요 시 포함하는 차트 자료
- `index.md`: GitHub Pages 또는 archive index용 시작 문서

## Content standard

- 단순 요약이 아니라 기사형/분석형 원문으로 작성합니다.
- 제품, 기업, 기술 배경과 영향을 설명합니다.
- 수치 비교나 추세가 핵심이면 차트를 포함합니다.
- 이미지가 독자 이해에 도움이 되고 권리상 문제가 없을 때 포함합니다.
